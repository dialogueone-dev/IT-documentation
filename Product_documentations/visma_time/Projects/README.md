# Projects in Intega Time

Employees must log their hours in Intega Time on the project(s) they have worked on.

The projects are set up according to the structure:  
**Client → Project → Task/process** (in Intega Time, the task/process is a **sub-project**).

Projects in Intega Time can be divided into two main categories: external and internal.
...
> When creating new projects in Intega Time, the following steps are taken:  
...
> [!NOTE]
> Clients are created and maintained in e-conomic and should therefore not be changed in Intega Time. For questions or errors regarding this, please contact Linda Guldbrandsen (lgb@dialogueone.dk).
